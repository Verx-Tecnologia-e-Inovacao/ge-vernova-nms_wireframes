...
**Exemplo do wireframe:** A subestacao de exemplo possui 4 IEDs reais com 6 streams SV na sub-rede W01 (4800 samples/s, 60 Hz).
...
|   SNMP   |  |  ----------+------------------+--------+-------------------+--------+-----|       |
|   Cfg    |  |  MU_360_1  | F4800S2I4U4_1    | 0x4001 | 01:0c:cd:04:00:01 | 0x044F | ...|       |
|          |  |  MU_360_1  | F4800S3I4U4_3    | 0x4003 | 01:0c:cd:04:00:03 | 0x044F | ...|       |
|          |  |  ----------+------------------+--------+-------------------+--------+-----|       |
|          |  |  MU320E_LAB| MU320E_LAB0101   | 0x4000 | 01:0c:cd:04:00:66 | -      | ...|       |
|          |  |  MU320E_LAB| MU320E_LAB0201   | 0x4000 | 01:0c:cd:04:01:2e | -      | ...|       |
|          |  |  MU_360_1  | F4800S2I4U4_2    | 0x4002 | 01:0c:cd:04:00:02 | -      | ...|       |
|          |  |  MU_360_1  | F4800S2I4U4_4    | 0x4004 | 01:0c:cd:04:00:04 | -      | ...|       |
|          |  |                                                                           |       |
|          |  |  --- colunas continuam (scroll horizontal ou layout responsivo) ---        |       |
|          |  |                                                                           |       |
|          |  |  ...| Rate | Freq | Subnet | Subscriber(s)     | Status                  |       |
|          |  |  ...+------+------+--------+-------------------+-------------------------|       |
|          |  |  ...| 4800 | 60Hz | W01    | L90_DIG, T60_DIG  | * Normal                |       |
|          |  |  ...| 4800 | 60Hz | W01    | L90_DIG, T60_DIG  | * Normal                |       |
|          |  |  ...+------+------+--------+-------------------+-------------------------|       |
...
- **Publisher:** Dropdown com todos os IEDs publishers (`Todos`, `MU_360_1`, `MU320E_LAB`, ...)
- **Subscriber:** Dropdown com todos os IEDs subscribers (`Todos`, `L90_DIG`, `T60_DIG`, ..., `Sem subscriber`)
...
**Exemplo com dados do F4800S2I4U4_1 (MU_360_1 → L90_DIG, T60_DIG):**

```
                              +----------------------------------------------+
                              | [X]                                          |
                              |                                              |
                              |  * F4800S2I4U4_1 — MU_360_1                  |
                              |  ----------------------------------------    |
                              |                                              |
                              |  -- Time Window --                           |
                              |                                              |
                              |  Inicio:  20/02/2026 19:19:00                |
                              |  Fim:     20/02/2026 19:19:13                |
                              |                                              |
                              |  -- Identificacao --                         |
                              |                                              |
                              |  Publisher:       MU_360_1                   |
...
#### Exemplo: Linha da tabela (dados SCD — 1 stream SV)

```json
{
  "publisher_ied": "MU_360_1",
  "ld_inst": "LDTM1",
  "cb_name": "F4800S2I4U4_1",
  "sv_id": "MU_360_1LDTM1/LLN0$MS$F4800S2I4U4_1",
  "dataset": "MU_360_1LDTM1/LLN0$PhsMeas1",
  "dataset_entries": 16,
  "conf_rev": 1,
  "app_id": "0x4001",
...
```json
{
  "publisher_ied": "MU320E_LAB",
  "ld_inst": "MU01",
  "cb_name": "MU320E_LAB0101",
  "sv_id": "MU320E_LABMU01/LLN0$MS$MU320E_LAB0101",
  "dataset": "MU320E_LABMU01/LLN0$Meas1",
  "dataset_entries": 16,
  "conf_rev": 1,
  "app_id": "0x4000",
  "dest_mac": "01:0c:cd:04:00:66",
  "vlan_id": "",
  "vlan_priority": 0,
  "asdu_count": 1,
  "subscribers": [],
  "subnetwork": "W01",
  "source_file": "MU320E_LAB_20260129.CID"
}
```
...
{
  "time_window": {
    "start": "2026-02-20T19:19:00.825923Z",
    "end": "2026-02-20T19:19:13.463593Z"
  },
  ...
  "metrics": [
    {
      "sv_id": "FoxIoT_MU01",
      "app_id": "0x4000",
      "dest_mac": "01:0c:cd:04:00:00",
      "vlan_id": ["0x0064"],
      "vlan_priority": [4],
      "dataset": "PROT_IED01/LLN0$MSVCB01",
      "dataset_entries": 16,
      "conf_rev": [1],
      "smp_synch": ["global"],
      "sampling_rate": 4800,
      ...
      "stats": {
        "eth0": {
          ...
          "counters": {
            "total_samples": 60634,
            "lost_packets": 27,
            "lost_packets_ts": "2026-02-20T19:19:02.066777Z",
            "out_of_order": 0,
          ...
          "packet_interval": {
            "nominal_us": 208.33,
            "min_us": 6.91,
            "min_ts": "2026-02-20T19:19:12.244919Z",
            "max_us": 13381.24,
            "max_ts": "2026-02-20T19:19:04.201602Z",
            "avg_us": 208.43,
            "std_us": 133.66
          },
          "processing_time": {
            "min_us": 233936.79,
            "max_us": 247338.29,
            "max_ts": "2026-02-20T19:19:04.201922Z",
            "avg_us": 234082.22,
            "std_us": 476.45
          },
          "clock_drift": {
            "min_us": -95.13,
            "min_ts": "2026-02-20T19:19:09.234006Z",
            "max_us": 748.16,
            "max_ts": "2026-02-20T19:19:04.234849Z"
          }
        },
        "eth1": {
          "prp_lans": ["B"],
          ...
          "counters": {
            "total_samples": 60636,
            "lost_packets": 25,
            "lost_packets_ts": "2026-02-20T19:19:02.066801Z",
            "out_of_order": 0,
            "out_of_order_ts": null,
            "duplicates": 0,
            "duplicates_ts": null
          ...
          "packet_interval": {
            "nominal_us": 208.33,
            "min_us": 5.82,
            "min_ts": "2026-02-20T19:19:12.244953Z",
            "max_us": 13156.45,
            "max_ts": "2026-02-20T19:19:04.201634Z",
            "avg_us": 208.42,
            "std_us": 135.81
          },
          "processing_time": {
            "min_us": 233980.52,
            "max_us": 247382.06,
            "max_ts": "2026-02-20T19:19:04.201965Z",
            "avg_us": 234125.99,
            "std_us": 476.51
          },
          "clock_drift": {
            "min_us": -99.58,
            "min_ts": "2026-02-20T19:19:09.234040Z",
            "max_us": 743.72,
            "max_ts": "2026-02-20T19:19:04.234844Z"
          }
        }
      }
    }
...
```json
{
  "sv_id": "MU_360_1_SV02",
  "app_id": "0x4003",
  "dest_mac": "01:0c:cd:04:00:03",
  "vlan_id": ["0x044F"],
  "vlan_priority": [5],
  "dataset": "MU_360_1LDTM2/LLN0$PhsMeas2",
  "dataset_entries": 16,
  "conf_rev": [1],
  "smp_synch": ["local"],
  "sampling_rate": 4800,
  ...
  "stats": {
    "eth0": {
      ...
      "counters": {
        "total_samples": 45230,
        "lost_packets": 142,
        "lost_packets_ts": "2026-02-20T19:19:01.234567Z",
        "out_of_order": 8,
        "out_of_order_ts": "2026-02-20T19:19:03.456789Z",
        "duplicates": 3,
        "duplicates_ts": "2026-02-20T19:19:05.678901Z"
      },
      "packet_interval": {
        "nominal_us": 208.33,
        "min_us": 2.15,
        "min_ts": "2026-02-20T19:19:08.123456Z",
        "max_us": 52847.92,
        "max_ts": "2026-02-20T19:19:01.234567Z",
        "avg_us": 210.87,
        "std_us": 487.12
      },
      "processing_time": {
        "min_us": 234012.45,
        "max_us": 248567.89,
        "max_ts": "2026-02-20T19:19:01.234890Z",
        "avg_us": 234156.78,
        "std_us": 512.34
      },
      "clock_drift": {
        "min_us": -245.67,
        "min_ts": "2026-02-20T19:19:10.234567Z",
        "max_us": 1523.45,
        "max_ts": "2026-02-20T19:19:01.234567Z"
      }
    },
    "eth1": {
      ...
      "counters": {
        "total_samples": 45228,
        "lost_packets": 144,
        "lost_packets_ts": "2026-02-20T19:19:01.234590Z",
        "out_of_order": 6,
        "out_of_order_ts": "2026-02-20T19:19:03.456812Z",
        "duplicates": 5,
        "duplicates_ts": "2026-02-20T19:19:05.679012Z"
      },
      "packet_interval": {
        "nominal_us": 208.33,
        "min_us": 1.89,
        "min_ts": "2026-02-20T19:19:08.123478Z",
        "max_us": 53012.45,
        "max_ts": "2026-02-20T19:19:01.234590Z",
        "avg_us": 210.92,
        "std_us": 492.34
      },
      "processing_time": {
        "min_us": 234056.12,
        "max_us": 248612.34,
        "max_ts": "2026-02-20T19:19:01.234912Z",
        "avg_us": 234200.45,
        "std_us": 515.67
      },
      "clock_drift": {
        "min_us": -250.12,
        "min_ts": "2026-02-20T19:19:10.234590Z",
        "max_us": 1528.90,
        "max_ts": "2026-02-20T19:19:01.234590Z"
      }
    }
...
```
> Usuario clica em uma linha (ex: F4800S2I4U4_1 - MU_360_1)
